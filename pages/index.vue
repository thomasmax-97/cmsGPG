<template>
  <div class="gpg-container h-screen flex flex-col justify-between"">
      <video
          ...
          muted>
          <source
              src="~/assets/video/gpg-gaming.mp4"
              type="video/mp4">
      </video>
...
<!--      </main>-->
    ...
    <footer class="p-2 text-center relative gpg-footer border-t-2 border-red">
